...
# Correspond to limitations noted in the paper (Sections 2.2, 2.3c, 4.7).
# Each script writes its own CSV to results/ and figure to figures/.
# They can also be sourced individually.
